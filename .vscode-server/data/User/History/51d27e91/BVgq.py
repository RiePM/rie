...
while True:
    ...
    #for x in range(0, 2):
    if am_pm == 'AM':
        hat.set_pixel(5, 7, 0, 255, 0)
        hat.set_pixel(6, 7, 0, 255, 0)
        hat.set_pixel(7, 7, 0, 255, 0)
        hat.set_pixel(4, 6, 0, 255, 0)
        hat.set_pixel(4, 2, 0, 255, 0)
        hat.set_pixel(5, 5, 0, 255, 0)
        hat.set_pixel(6, 5, 0, 255, 0)
        hat.set_pixel(7, 5, 0, 255, 0)
    else:
