...
while True:
    ...
    display_digit1(t.hour, 5, hour_color)
    display_digit2(t.hour, 6, hour_color)
    display_digit1(t.minute, 3, minute_color)
    display_digit2(t.minute, 4, minute_color)
    display_digit1(t.second, 1, second_color)
    display_digit2(t.second, 2, second_color)
    time.sleep(0.0001)