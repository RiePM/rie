...
while True:
    ...
    if cur_clock == "6col12formClock":
        ...
        display_digit1(hour, 0, hour_color)
        display_digit2(hour, 1, hour_color)
        display_digit1(t.minute, 2, minute_color)
        display_digit2(t.minute, 3, minute_color)
        display_digit1(t.second, 4, second_color)
