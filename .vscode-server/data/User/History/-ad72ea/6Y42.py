...
while True:
    ...
    if cur_clock == "6col12formClock":
        ...
        # A
            ...
            hat.set_pixel(7, 6, 0, 155, 155)
            hat.set_pixel(7, 7, 0, 155, 155)
            hat.set_pixel(6, 4, 0, 155, 155)
            hat.set_pixel(6, 6, 0, 155, 155)
            hat.set_pixel(5, 5, 0, 155, 155)
            hat.set_pixel(5, 6, 0, 155, 155)
            hat.set_pixel(5, 7, 0, 155, 155)
            # M
            hat.set_pixel(3, 4, 0, 155, 155)
            hat.set_pixel(3, 5, 0, 155, 155)
            hat.set_pixel(3, 6, 0, 155, 155)
            hat.set_pixel(3, 7, 0, 155, 155)
